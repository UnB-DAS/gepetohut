class OrdersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @order.save
        format.html { redirect_to @order, notice: 'Pedido foi criado com sucesso' }
  ...
  def update
    respond_to do |format|
      if @order.update(order_params)
        format.html { redirect_to @order, notice: 'Pedido foi atualizado com sucesso.' }
  ...
  def destroy
    @order.destroy
    respond_to do |format|
      format.html { redirect_to orders_url, notice: 'Pedido foi cancelado com sucesso.' }
